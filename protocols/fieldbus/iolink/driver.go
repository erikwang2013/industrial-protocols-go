...
// NewGatewayDriver creates an IO-Link GatewayBridge + codec for the given
// TCP address (e.g. "192.168.1.100:2004").
func NewGatewayDriver(address string) (bridge.Bridge, kernel.Codec, error) {
	return bridge.NewGatewayBridge(address), &iolinkCodec{}, nil
}
