...
// NewGatewayDriver creates a Foundation Fieldbus GatewayBridge + codec for
// the given TCP address (e.g. "192.168.1.100:2002").
func NewGatewayDriver(address string) (bridge.Bridge, kernel.Codec, error) {
	return bridge.NewGatewayBridge(address), &foundationfieldbusCodec{}, nil
}
