...
// NewGatewayDriver creates an Interbus GatewayBridge + codec for the given
// TCP address (e.g. "192.168.1.100:2006").
func NewGatewayDriver(address string) (bridge.Bridge, kernel.Codec, error) {
	return bridge.NewGatewayBridge(address), &interbusCodec{}, nil
}
